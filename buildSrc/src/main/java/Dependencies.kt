...
object DaggerHilt {
    ...
    const val dagger_compiler = "com.google.dagger:hilt-android-compiler:${Version.dagger_version}"
    const val dagger_capt = "androidx.hilt:hilt-compiler:${Version.hilt_compiler}"
